...
export const metadata: Metadata = {
  ...
  description:
    "Tasya Amalia Salsabila is an Android Engineer with 6+ Years in Mobile Development building production fintech and banking systems across onboarding, payments, investment, lending, authentication, and security.",
  keywords: [
